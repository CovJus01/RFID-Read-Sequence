...
int main(int argc, char *argv[]) {
	...
	***************** */
	...
	gtk_box_pack_start(GTK_BOX(admin_page), admin_scroll_window, FALSE, FALSE, 5);
	gtk_box_pack_start(GTK_BOX(admin_login_page), item_prompt_label, FALSE, FALSE, 0);
	gtk_box_pack_start(GTK_BOX(admin_login_page), item_prompt_entry, FALSE, FALSE, 0);
	gtk_box_pack_start(GTK_BOX(admin_login_page), button_assign_tags, FALSE, FALSE, 0);
